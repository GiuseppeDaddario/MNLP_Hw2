...
def translate_with_smaLLM(FILE_NAME, print_result=True):
    print("\n")
    print("|========================================")
    ...
    output_path = f"datasets/eng/corrections/{FILE_NAME}_smaLLM.json"
    ...
    for i, key in enumerate(ocr_data.keys()):
        ...
        for j, sentence in enumerate(sentences):
            ...
            final_sentence = spellcheck_text(corrected)
