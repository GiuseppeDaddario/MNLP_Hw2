...
#SBATCH --output=CINECA/logs/minerva_finetuning_llima_postocr.out
#SBATCH --error=CINECA/logs/minerva_finetuning_llima_postocr.err
...
python src/models/minerva/finetuning.py
